    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                <div class="sidebar-brand-text mx-3">Double Click</div>
            </a>
            <!-- Divider -->
            ...
            <li class="nav-item">
                ...
                <div id="collapseDonHang" class="collapse" aria-labelledby="headingDonHang" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#">Hủy hàng</a>
                    </div>
                </div>
            </li>
            <!-- Bình luận đánh giá -->
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                                ...
                                <a class="dropdown-item text-center small text-black-500" href="#">Show All
                                    Alerts</a>
                            </div>
                        </li> -->
                        <!-- Nav Item - Messages -->
                        <!-- <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                                ...
                                <a class="dropdown-item text-center small text-black-500" href="#">Read More
                                    Messages</a>
                            </div>
                        </li> -->
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="{{ asset('img/' . ($account->Image ?: 'default.jpg')) }}">
                            </a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-black-800">
                            @yield('subtitle')
                        </h1>
                    </div>
                    <div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Double Click 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{route('logout')}}" method="post">
                        ...
                        <button class="btn btn-primary" type="submit">Đăng xuất</>
                    </form>
                </div>
            </div>
        </div>
