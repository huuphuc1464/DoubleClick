            ...
            <form action="{{ route('staff.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control @error('NgaySinh') is-invalid @enderror" id="NgaySinh" name="NgaySinh" value="{{ old('NgaySinh') }}" required>
                        @error('NgaySinh')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('MaRole') is-invalid @enderror" id="MaRole" name="MaRole" required>
                            @foreach ($roles as $role)
                                <option value="{{ $role->MaRole }}" {{ old('MaRole') == $role->MaRole ? 'selected' : '' }}>
                                    {{ $role->TenRole }}
                                </option>
                            @endforeach
                        </select>
