...
@section('content')
                ...
                <div class="d-flex flex-column flex-md-row">
                    <div class="header" style="flex: 0 0 25%; background-color: #f8f9fa; padding: 15px;">
                        <div class="d-none d-md-block">
                            ...
                            <a href="{{ route('staff.create') }}" class="btn btn-primary w-100 mb-2">Thêm Nhân Viên</a>
                            <a href="{{ route('staff.index') }}" class="btn btn-danger w-100 mb-2">Nhân viên đã xóa</a>
                        </div>
                        <div class="d-block d-md-none">
                            <a href="{{ route('staff.index') }}" class="btn btn-secondary w-100 mb-2">Nhân viên</a>
                            <a href="{{ route('staff.create') }}" class="btn btn-primary w-100 mb-2"><i
                                    class="fa fa-user-plus"> Thêm nhân viên</i></a>
                            <a href="{{ route('staff.index') }}" class="btn btn-danger w-100 mb-2"><i
    ...
    <Style>
        ...
        @media (max-width: 768px) {
            ...
            .list-group-item h4 {
                font-size: 11px;
                /* Giảm kích thước văn bản cho màn hình nhỏ */
            }
        }
        ...
        @media (max-width: 480px) {
            .btn-action a {
                font-size: 14px;
                /* Giảm thêm kích thước biểu tượng */
                width: 25px;
                height: 25px;
            }
            ...
            .list-group-item h4 {
                font-size: 10px;
                /* Giảm kích thước văn bản để phù hợp màn hình nhỏ hơn */
            }
        }
    </Style>
@endsection
