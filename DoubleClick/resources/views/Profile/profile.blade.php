...
<form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
    ...
    <div class="form-item profile-picture">
        ...
        <div class="profile-pic-container">
            ...
            <img id="profile-pic-preview" src="{{ asset('/img/Profile/' . ($account->Image ?: 'default.jpg')) }}" alt="Profile Picture" class="img-thumbnail" style="max-width: 150px; max-height: 150px; object-fit: cover;">
            <!-- Input để chọn ảnh -->
