...
<body>
    ...
    <div class="col-md-8">
        ...
        <div class="mb-4 p-3 rounded shadow-sm" style="background-color: #ffffff;">
            ...
            <div class="mb-3">
                <label for="addressInput" class="form-label fw-bold">Nhập địa chỉ</label>
                <input type="text" class="form-control" id="addressInput" placeholder="Nhập số nhà, tên đường...">
            </div>
